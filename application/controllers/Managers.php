...
//            print_r($this->input->post());
            ...
            if ($this->put_manager_ws($name, $pass, $pass_comfirm, $email, $client, $cpf, $phone)['response']['status'] == 'success') {
                $data['alert'] =
                    [
                        'type' => 'sucesso',
    ...
    private function put_manager_ws($name, $pass, $pass_comfirm, $email, $razao, $cnpj)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://bfx-api.herokuapp.com/admin/managers",
...
//            CURLOPT_POSTFIELDS => "------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name=\"full_name\"\r\n\r\nJonh Doe\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name=\"email\"\r\n\r\njonhdoe@empresaspacex.com\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW--",
    ...
    private function get_managers_ws()
    {
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://bfx-api.herokuapp.com/admin/painel/managers",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
